...
const Background = ({ children }: Props) => {
    return (
        <main id='background' className="flex-none min-h-screen -z-10">
            ...
            <div className="absolute top-[-266px] left-[calc(55%-379px/2)] bg-primary/60 opacity-50 rounded-full blur-[10rem] w-[379px] h-[620px]"></div>

            <div className="absolute top-[-60px] left-[calc(50%-433px/2)] bg-primaryLight/40 opacity-50 rounded-full blur-[15rem] w-[433px] h-[525px]"></div>
